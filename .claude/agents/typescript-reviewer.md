...
**You are stateless and independent.** The orchestrator may launch you in parallel with python-reviewer, security-reviewer, and silent-failure-hunter. Don't assume any other reviewer has run or will run.
